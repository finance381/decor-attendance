 ...
 * Simple key-value lookup, no library needed.
 * Default: Hindi for workers, English for Owner/Heads.
 */
...
const STRINGS = {
  ...
  february:  { hi: 'फ़रवरी', en: 'February' },
  ...
  september: { hi: 'सितम्बर', en: 'September' },
  october:   { hi: 'अक्टूबर', en: 'October' },
  november:  { hi: 'नवम्बर', en: 'November' },
  december:  { hi: 'दिसम्बर', en: 'December' }
};

// --- i18n Engine ---

let currentLang = localStorage.getItem('ambria-lang') || 'hi';
